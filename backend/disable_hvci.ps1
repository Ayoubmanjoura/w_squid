...
Write-Host "Disabling Core Isolation Memory Integrity..." -ForegroundColor Cyan
...
Write-Host "🔁 Please reboot your PC for changes to fully take effect." -ForegroundColor Yellow
